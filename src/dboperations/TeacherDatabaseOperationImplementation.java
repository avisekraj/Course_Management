...
public class TeacherDatabaseOperationImplementation implements TeacherDatabaseOperation {
    ...
    public static String addCourse(String cid, String ccode, String cname, String section) {
        String query = "insert into course values('" + Integer.parseInt(cid) + "','" + ccode + "','" + cname + "','" + Integer.parseInt(section) + "');";
        String query1 = "select * from course where Course_Code='" + ccode + "'";
        Connection connection = DBConnection.getConnection();
        try {
            Statement statement = connection.createStatement();
            ...
            if (!rs.next()) {
                ...
                return "Course Added,"+ccode+" Course has been added Successfully";
        ...
        return "Duplicate Found,"+"Course already Present";
    }
}
